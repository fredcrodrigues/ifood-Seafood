...
import 'modal_category_model.dart';
export 'modal_category_model.dart';

class ModalCategoryWidget extends StatefulWidget {
  const ModalCategoryWidget({Key? key}) : super(key: key);
...
class _ModalCategoryWidgetState extends State<ModalCategoryWidget> {
  late ModalCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCategoryModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await CategoryClientRecord.collection
                            .doc()
                            .set(createCategoryClientRecordData(
