...
import 'modal_admin_clien_model.dart';
export 'modal_admin_clien_model.dart';

class ModalAdminClienWidget extends StatefulWidget {
  const ModalAdminClienWidget({
    Key? key,
  ...
  @override
  _ModalAdminClienWidgetState createState() => _ModalAdminClienWidgetState();
}

class _ModalAdminClienWidgetState extends State<ModalAdminClienWidget> {
  late ModalAdminClienModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalAdminClienModel());
    ...
    _model.usernameWebController ??= TextEditingController();
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: (_model
                                            ...
                                            : () async {
                                                ...
                                                GoRouter.of(context)
                                                    .prepareAuthEvent();
                                                if (_model.passwordWebController
                                                        .text !=
                                                    _model
                                                        .replacepasswordWebController
                                                        .text) {
