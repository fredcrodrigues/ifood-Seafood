...
import 'modal_update_client_web_widget.dart' show ModalUpdateClientWebWidget;
...
class ModalUpdateClientWebModel
    extends FlutterFlowModel<ModalUpdateClientWebWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in modalUpdateClientWeb widget.
