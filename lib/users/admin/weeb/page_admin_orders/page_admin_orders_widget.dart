...
import 'page_admin_orders_model.dart';
export 'page_admin_orders_model.dart';

class PageAdminOrdersWidget extends StatefulWidget {
  const PageAdminOrdersWidget({
    Key? key,
    this.refDate,
    this.refText,
  }) : super(key: key);
  ...
  @override
  _PageAdminOrdersWidgetState createState() => _PageAdminOrdersWidgetState();
}

class _PageAdminOrdersWidgetState extends State<PageAdminOrdersWidget> {
  late PageAdminOrdersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageAdminOrdersModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().stateFilter = false;
      });
    });
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    if (FFAppState().stateFilter == false) {
                      return Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 0.0),
                        child: StreamBuilder<List<OrdersRecord>>(
                          stream: _model.listOrdersPageCache(
                            requestFn: () => queryOrdersRecord(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              detailsOrderShopCartRecord.subTotal.toString(),
                                                                              'plk',
                                                                            ),
                                                                            textAlign:
                                                                                TextAlign.center,
