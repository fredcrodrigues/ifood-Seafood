...
import 'modal_edit_local_model.dart';
export 'modal_edit_local_model.dart';

class ModalEditLocalWidget extends StatefulWidget {
  const ModalEditLocalWidget({Key? key}) : super(key: key);

  @override
  _ModalEditLocalWidgetState createState() => _ModalEditLocalWidgetState();
}

class _ModalEditLocalWidgetState extends State<ModalEditLocalWidget> {
  late ModalEditLocalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEditLocalModel());
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.enderecoControllerValidator
                            .asValidator(context),
                        inputFormatters: [_model.enderecoMask],
                      ),
                    ),
                  ),
                  Align(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.complementoControllerValidator
                            .asValidator(context),
                        inputFormatters: [_model.complementoMask],
                      ),
                    ),
                  ),
                  Align(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.bairroControllerValidator
                            .asValidator(context),
                        inputFormatters: [_model.bairroMask],
                      ),
                    ),
                  ),
                  Align(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.cidadeControllerValidator
                            .asValidator(context),
                        inputFormatters: [_model.cidadeMask],
                      ),
                    ),
                  ),
                  Align(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.estadoControllerValidator
                            .asValidator(context),
                        inputFormatters: [_model.estadoMask],
                      ),
                    ),
                  ),
                  if (_model.stateText == true)
                    Align(
                      alignment: AlignmentDirectional(0.00, 0.00),
                      child: Padding(
                        padding:
                        ...
                        child: Text(
                          ...
                          style: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                fontFamily: 'Poppins',
                                color:
                                    FlutterFlowTheme.of(context).orangeCamaron,
                              ),
                        ),
                      ),
                    ),
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if ((_model.enderecoController.text != null &&
                                _model.enderecoController.text != '') &&
                            (_model.numeroController.text != null &&
                                _model.numeroController.text != '') &&
                            (_model.cepController.text != null &&
                                _model.cepController.text != '') &&
                            (_model.cidadeController.text != null &&
                                _model.cidadeController.text != '') &&
                            (_model.estadoController.text != null &&
                                _model.estadoController.text != '')) {
                          await currentUserReference!
                              .update(createUsersRecordData(
                            adress: _model.enderecoController.text,
                            cep: _model.cepController.text,
                            number: _model.numeroController.text,
                            complement: _model.complementoController.text,
                            city: _model.cidadeController.text,
                            state: _model.estadoController.text,
                          ));
                          Navigator.pop(context);
                        } else {
                          setState(() {
                            _model.stateText = true;
                          });
                        }
                      },
                      text: 'Atualizar',
